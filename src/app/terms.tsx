 ...
 * Renders the full official Terms of Service for web visitors, deep links,
        ...
        >
          ...
          <View style={styles.header}>
            ...
            <View style={styles.titleBlock}>
              ...
              <ThemedText style={styles.title}>{TERMS_OF_SERVICE.title}</ThemedText>
              <ThemedText style={styles.subtitle}>Effective Date: {TERMS_OF_SERVICE.lastUpdated}</ThemedText>
            </View>
          </View>
